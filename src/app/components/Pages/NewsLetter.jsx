    ...
    return (
        <div data-aos="fade-up" className='w-9/12 mx-auto text-center my-24 py-16 border border-[#F0F0F2] rounded-2xl shadow-[0_20px_50px_rgba(79,70,229,0.12)]'>
            <div className='text-center'>
                <h2 className={`text-3xl font-bold text-[#141B2B] ${hankenGrotesk.className}`}>Subscribe our Newsletter</h2>
            ...
            <div>
                <Form className='my-6 flex justify-center items-center gap-3'>
                    <TextField
                        isRequired
                        name="name"
                        type="email"
                    ...
                    >
                        <div className="relative flex items-center">
                            <Input
                                ...
                                className={`text-[#A2A2A8] w-85.75 py-4.5 px-5 border border-[#E7E7E7] rounded-2xl ${hankenGrotesk.className}`}
                            />
                        </div>
                        <FieldError />
                    </TextField>
