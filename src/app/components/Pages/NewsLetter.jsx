...
const NewsLetter = () => {
    return (
        <div data-aos="fade-up" className='lg:w-9/12 w-11/12 mx-auto text-center my-24 py-16 border border-[#F0F0F2] rounded-2xl shadow-[0_20px_50px_rgba(79,70,229,0.12)]'>
